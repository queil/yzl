...
:--- | :--- | :---:
[<code><span>Named(<span>name,&#32;node</span>)</span></code>](#Named) | Parameters<br /><br />**name**: <code><a href="https://queil.github.io/yzl/reference/yzl-core-yzl-name">Name</a></code><br />**node**: <code><a href="https://queil.github.io/yzl/reference/yzl-core-yzl-node">Node</a></code><br /> | [![Link to source code](https://queil.github.io/yzl/content/img/github.png)](https://github.com/queil/yzl/tree/master/src/Yzl/Yzl.fs#L69-69)
