...
module Builders =
  ...
  let options value = Yzl.map(value, "options")
  ...
  let behavior value = Yzl.str(value, "behavior")
  ...
  let labels value = Yzl.map(value, "labels")
  let objref value = Yzl.map(value, "objref")
  let fieldref value = Yzl.map(value, "fieldref")
  let count value = Yzl.float(value, "count")
  let inline targets value = Yzl.seq(value, "targets")
  let source value = Yzl.map(value, "source")
  ...
  let inline labels value = Yzl.seq(value, "labels")
