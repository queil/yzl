...
type Kustomization() =
    ...
    static member patchesStrategicMerge(value: string list) =
        Yzl.seq (value, "patchesStrategicMerge")
...
type GeneratorOptions() =
    ...
    static member disableNameSuffixHash(value: bool) =
        Yzl.boolean (value, "disableNameSuffixHash")
